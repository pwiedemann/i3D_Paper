...
r_{diffuse} = 
\begin{cases}
\textbf{40.022 : 1} , & \mbox{for } 256^2 \mbox{ \#vertices} \\
\textbf{160.088 : 1} & \mbox{for } 512^2 \mbox{ \#vertices}
\end{cases}
\\
r_{glossy} = 
\begin{cases}
\textbf{120.066 : 1} , & \mbox{for } 256^2 \mbox{ \#vertices} \\
\textbf{480.264 : 1} & \mbox{for } 512^2 \mbox{ \#vertices}
\end{cases}
\end{align*}
This number grows linearly with an increasing number of coefficients, number of deformations or number vertices. 
%%%%% TABLE %%%%%%%%%%%
\begin{table}[H]
